...
import com.nikitoe.stockdividend.model.constants.Month;
...
@Component
public class YahooFinanceScarper implements Scraper {
    ...
    public ScrapedResult scrap(Company company) {
        ...
        try {
            ...
            Element tbody = tableEle.children().get(1); // table의 tbody 만
            ...
            for (Element e : tbody.children()) {
                ...
                int month = Month.strToNumber(splites[0]); // 월
